...
105: "DXGI_FORMAT_Y216",
106: "DXGI_FORMAT_NV11",
107: "DXGI_FORMAT_AI44",
108: "DXGI_FORMAT_IA44",
109: "DXGI_FORMAT_P8",
110: "DXGI_FORMAT_A8P8",
111: "DXGI_FORMAT_FORCE_UINT"
...
class TextureLoader:
    ...
    def load_texture(dds_path):
        try:
            ...
            if dds_info and dds_info.get("is_problematic", False):
                ...
                return TextureLoader.load_with_texconv(dds_path)
    ...
    @staticmethod
    def load_with_texconv(dds_path):
